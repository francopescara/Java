...
Nota: Formula ecuación 2o grado: - Solo varia el signo delante de -b
 */
package ejercicioextra3;

import ejercicioextra3.newpackage.Raices;
import ejercicioextra3.newpackage1.servicioRaices;
...
public class EjercicioExtra3 {
    ...
    public static void main(String[] args) {
        servicioRaices o=new servicioRaices();
        Raices r=o.getDiscriminante();
       /* System.out.println("------------------");
        o.tieneRaices(r);
        System.out.println("------------------");
        o.tieneRaiz(r);
